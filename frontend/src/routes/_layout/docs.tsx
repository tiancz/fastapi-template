...
function getDocsQueryOptions({ page }: { page: number }) {
  return {
    queryFn: () =>
      DocsService.readItems({ skip: (page - 1) * PER_PAGE, limit: PER_PAGE }),
    queryKey: ["items", { page }],
  }
}
      ...
      <Table.Root size={{ base: "sm", md: "md" }}>
        <Table.Header>
          <Table.Row>
            ...
            <Table.ColumnHeader w="sm">Path</Table.ColumnHeader>
