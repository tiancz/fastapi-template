...
import {type KnowledgeBaseCreate, KnowledgeBaseService} from "@/client"
...
const AddKnowledgeBase = () => {
  ...
  const mutation = useMutation({
    mutationFn: (data: KnowledgeBaseCreate) =>
      KnowledgeBaseService.createKnowledgeBase({ requestBody: data }),
    onSuccess: () => {
  ...
  return (
    ...
    >
      <DialogTrigger asChild>
        <Button value="add-knowledge-base" my={4}>
