...
import { type ApiError, type KnowledgeBasePublic, KnowledgeBaseService } from "@/client"
...
const EditKnowledgeBase = ({ item }: EditKnowledgeBaseProps) => {
  ...
  const mutation = useMutation({
    mutationFn: (data: KnowledgeBaseUpdateForm) =>
      KnowledgeBaseService.updateKnowledgeBase({ id: item.id, requestBody: data }),
    onSuccess: () => {
      showSuccessToast("KnowledgeBase updated successfully.")
      reset()
      setIsOpen(false)
    },
